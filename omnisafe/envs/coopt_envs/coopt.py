...
T_batt = 273.15 + 27  # ambient temperature, Kelvin
z = 0.57  # power law factor
soc_nom = 0.6  # nominal battery state of charge
TK_nom = T_batt  # nominal temperature, Kelvin
Ic_nom = 2.5  # nominal C-rate
Ic_max = 10
...
class EMSEnv(gym.Env):
    def __init__(self, cycle):
        ...
        # nominal batt life
        self.BATT_LIFE_NOM = self._get_batt_life(soc_nom, TK_nom, Ic_nom)
    ...
    def step(self, action: list):
        ...
        c_rate = abs(bat_curr) / Qmax
        batt_life = self._get_batt_life(soc, T_batt, c_rate)
        severity = self.BATT_LIFE_NOM / batt_life
