...
class AlgoWrapper:
    ...
    def evaluate(self, num_episodes: int = 10, cost_criteria: float = 1.0) -> tuple:
        """Agent Evaluation.
        ...
        episode_rewards, episode_costs, best_model = evaluation_all(
            log_dir=self.agent.logger.log_dir,
            save_mat=True,
        )

        return episode_rewards, episode_costs, best_model
